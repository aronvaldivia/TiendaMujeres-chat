...
import { ChevronLeft, ChevronRight, ShoppingBag, Phone, Mail, Instagram, Facebook, MapPin, ExternalLink, Star, Send } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-4xl font-bold">Limited Edition Evening Collection</h2>
              <p className="text-xl text-gray-600">
                Discover our exclusive evening wear collection, featuring handcrafted pieces that blend timeless elegance with contemporary design. Each piece is meticulously created using premium materials and expert craftsmanship.
              </p>
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  <span className="w-4 h-4 rounded-full bg-rose-500"></span>
                  <span>Premium silk and sustainable materials</span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="w-4 h-4 rounded-full bg-rose-500"></span>
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  onClick={() => handleWhatsApp("Limited Edition Evening Collection")}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-rose-500 text-white px-6 py-3 rounded-lg hover:bg-rose-600 transition-colors flex items-center justify-center"
              >
